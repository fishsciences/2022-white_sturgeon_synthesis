...
data_clean/alltags.rds : R/combine_tags.R data/data_dir_local.rds $(TAGS_RAW)
	$(RSCRIPT)

data/WST_detections.rds : R/combine_detections.R data_clean/alltags.rds data/data_dir_local.rds $(DETS_RAW)
	$(RSCRIPT)

data_clean/alldeps.rds : R/clean_deployments.R R/overlap_funs.R 					\
...
data_clean/alldets.rds : R/qaqc_detections.R data_clean/alldeps.rds data/WST_detections.rds data_clean/alltags.rds
	$(RSCRIPT)
	
data_clean/all_rec_locs.csv : R/receiver_map.R data_clean/alldeps.rds
	$(RSCRIPT)
	
data_clean/orphan_dets.csv : R/qaqc_detections.R data_clean/alldeps.rds data/WST_detections.rds data_clean/alltags.rds
	$(RSCRIPT)
